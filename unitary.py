...
def U4SPH(params):
    ...
    return array([[a, b * c, b * d * e, b * d * f],
                  [bc * g, -ac * c * g + dc * h * l, -ac * d * e * g - cc * e * h *
                      l + fc * h * m, -ac * d * f * g - cc * f * h * l - ec * h * m],
                  [bc * hc * j, -ac * c * hc * j - dc * gc * j * l + dc *
                      kc * mc, m3a * e + m3b * fc, m3a * f - m3b * ec],
                  [bc * hc * k, -ac * c * hc * k - dc * gc * k * l -
                   dc * jc * mc, m4a * e + m4b * fc, m4a * f - m4b * ec]
                  ])
